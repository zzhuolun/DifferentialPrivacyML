...
class MultilayerPerceptronAttacker(TrainedAttacker):
    ...
    def train_model(self, input_features, is_training_labels):
        ...
        param_grid = {
            'hidden_layer_sizes': [(64,), (32, 32), (32,), (16, 16)],
            'solver': ['adam'],
...
class SVMAttacker(TrainedAttacker):
    """SVM atttacker"""
    def train_model(self, input_features, is_training_labels):
        ...
        model = model_selection.GridSearchCV(
            svm_model, param_grid=param_grid, cv=3, n_jobs=1, verbose=0)
        model.fit(input_features, is_training_labels)
        self.model = model


class GPCAttacker(TrainedAttacker):
    """Gaussian Process Classifier attacker"""
    def train_model(self, input_features, is_training_labels):
        ...
        model = model_selection.GridSearchCV(
            gpc_model, param_grid=param_grid, cv=3, n_jobs=1, verbose=0)
        model.fit(input_features, is_training_labels)
        self.model = model


class DTAttacker(TrainedAttacker):
    ...
    def train_model(self, input_features, is_training_labels):
        ...
        model = model_selection.GridSearchCV(
            dt_model, param_grid=param_grid, cv=3, n_jobs=1, verbose=0)
        model.fit(input_features, is_training_labels)
        self.model = model

class AdaBoostAttacker(TrainedAttacker):
    """Ada boost attacker"""
    def train_model(self, input_features, is_training_labels):
        ...
        model = model_selection.GridSearchCV(
            adaboost_model, param_grid=param_grid, cv=3, n_jobs=1, verbose=0)
        model.fit(input_features, is_training_labels)
        self.model = model
